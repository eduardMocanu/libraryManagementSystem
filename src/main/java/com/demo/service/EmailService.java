...
public abstract class EmailService {
    ...
    public static void sendEmailTo(String emailClient, String bookName, String clientName, String dateEnd){
        ...
        try{
            ...
            msg.setText("Hi " + clientName + "\n"+
                    "The loan for the book " + bookName + " has expired on date " + dateEnd + "\n"+
